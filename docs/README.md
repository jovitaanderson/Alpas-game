...
* Aseprite (To design the tileset and characters)
* VSCode (IDE)
* C# (The language used to develop the game)
* WebGL (The platform used to build the game)
* Itch.io (The server used for hosting the game)

# Credits 📋
‘Alpas' is a game project developed by us, it is a free-to-play game for the general public and we do not intend to make any revenue from it. Due to the time constraints of the submission for this project, several assets, music, and questions used in this game were not created by us. Below are the credits and links of the rightful owners of each asset, music, and question used in our game. 

[Credits and special thanks](https://docs.google.com/document/d/1GA0iyH_So2eDQ_1D8-6ZMCQPOid89I2FyNmXJ3fEP_I/edit?usp=sharing)
