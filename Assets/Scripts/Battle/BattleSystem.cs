...
public class BattleSystem : MonoBehaviour
{
        ...
        Sprite backgroundBattle, Sprite backgroundCirclesBattle, BattleTrigger trigger = BattleTrigger.LongGrass)
    {
        ...
        GameObject.Find("GameController").GetComponent<GameController>().animaList.AnimalSeen(wildAnimal);
    ...
    public IEnumerator SetupBattle()
    {
        ...
        else
        {
            ...
            GameObject.Find("GameController").GetComponent<GameController>().animaList.AnimalSeen(enemyAnimal);
