...
public class BattleSystem : MonoBehaviour
{
    ...
    void HandleActionSelection()
    {
        ...
        if (Input.GetKeyDown(ControlManager.i.getKey("CONFIRM")) || Input.GetKeyDown(KeyCode.Space)) //return = enter key
        {
            if (currentAction == 0)
            {
                // Fight
    ...
    void HandleMoveSelection()
    {
        ...
        if (Input.GetKeyDown(ControlManager.i.getKey("CONFIRM")) || Input.GetKeyDown(KeyCode.Space))
        {
        ...
        else if (Input.GetKeyDown(ControlManager.i.getKey("BACK")) || Input.GetKeyDown(KeyCode.Backspace))
        {
            dialogBox.EnableMoveSelector(false);
            dialogBox.EnableDialogText(true);
            ActionSelection();
    ...
    {
        if(Input.GetKeyDown(ControlManager.i.getKey("UP")) || Input.GetKeyDown(ControlManager.i.getKey("DOWN")))
